...
public class WebServer {
     ...
     * Web service operation
     */
    @WebMethod(operationName = "isValidate")
     ...
     * Web service operation
     */
    @WebMethod(operationName = "addBolck")
    public String addBolck(@WebParam(name = "data") String data, @WebParam(name = "diff") int diff) {
...
// split helper 
     ...
     * Web service operation
     */
    @WebMethod(operationName = "isValidateString")
